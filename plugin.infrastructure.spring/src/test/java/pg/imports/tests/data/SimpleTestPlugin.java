...
public class SimpleTestPlugin extends TestPlugin {
    public SimpleTestPlugin(final ParsingComponentsProvider<TestRecord, ParsedRecord<TestRecord>> parsingProvider,
