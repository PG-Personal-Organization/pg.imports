package pg.imports.plugin.infrastructure.spring.batch.importing.listeners;
...
@Log4j2
public class SimpleImportingExecutionErrorListener implements StepExecutionListener {
